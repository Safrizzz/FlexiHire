...
// ============================================================================
class employer_transfer_page extends StatefulWidget {
  const employer_transfer_page({Key? key}) : super(key: key);

  @override
  State<employer_transfer_page> createState() => _EmployerTransferPageState();
}

// ============================================================================
// THIS IS THE PAGE STATE - Where all the code and UI happens
// ============================================================================
class _EmployerTransferPageState extends State<employer_transfer_page> {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Colors.black.withOpacity(0.4), // Shadow with 40% opacity
                      spreadRadius: 0,
                      blurRadius: 16,
